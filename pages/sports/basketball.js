...
import BasketballMatch from "../../components/InterHall/BasketballMatch";
...
export default function Volleyball() {
    ...
    useEffect(() => {
        fetch(dataUrl + '?sheetName=Basketball')
            ...
            <Layout>
                ...
                <section className="m-content">
                    <div className={`facilities`}>
                        <section>
                            <h2>
                                Inter Hall Basketball Gymkhana Championship 2022
                            </h2>
                            {/* <p>
                                Welcome!
                            </p> */}
                            ...
                            <>
                                {
                                    isLoading ? (
                                        ...
                                        matchesData.map((data, index) => (
                                            <BasketballMatch key={index} data={data} />
                                        )
                                        )
                                    )
                                }
